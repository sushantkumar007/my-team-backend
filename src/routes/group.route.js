...
groupRouter.route("/groups").get(isAuthenticated, getGroups);
groupRouter.route("group/:groupId").get(isAuthenticated, deleteGroup);
groupRouter.route("/invite-user/:groupId").post(isAuthenticated, invite);
groupRouter.route("/invites/:groupId").get(isAuthenticated, getInvites);
groupRouter.route("/requests/:groupId").get(isAuthenticated, getRequests);
...
groupRouter.route("/remove-members/:groupId").post(isAuthenticated, removeMember);
